        ...
        <section className="bg-bg border-b border-border/50">
            <div className="max-w-7xl mx-auto px-6 md:px-8 py-24">
                ...
                <div className="text-center mb-20">
                    <p className="text-[10px] tracking-[0.4em] uppercase text-accent mb-4">Find Us</p>
                ...
                {/* Info Grid: No boxes, just clean separation */}
                <div className="grid md:grid-cols-3 gap-12 border-t border-border/30 pt-16">
                    ...
                    {/* Address - Keep your map but make it an "accent" */}
                    <div className="text-center">
                        <p className="text-[10px] tracking-[0.4em] uppercase text-accent mb-4">Address</p>
                    ...
                    {/* Phone */}
                    <div className="text-center">
                        <p className="text-[10px] tracking-[0.4em] uppercase text-accent mb-4">Phone</p>
