...
export function Hero() {
    ...
    return (
        <section className="relative overflow-hidden border-b border-white/10 bg-dark min-h-[85vh] flex items-center">
            ...
            {/* Container: Changed to flex-col and justify-center to force vertical alignment */}
            <div className="relative max-w-7xl mx-auto px-6 py-10 z-10 w-full flex flex-col justify-center min-h-[70vh]">

                {/* Content: This will now center perfectly on both mobile and desktop */}
                <div className="max-w-3xl">
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-8xl lg:text-9xl uppercase font-heading tracking-wide text-white leading-[0.9] mb-8"
                    >
