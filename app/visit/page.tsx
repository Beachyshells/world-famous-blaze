        ...
        <div className="min-h-screen">
            ...
            <div className="bg-surface border-b border-border">
                <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-24">
                    ...
                    <h1 className="text-4xl md:text-5xl font-heading text-text mb-4">Visit</h1>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-start gap-4">
                                    <span className="text-primary text-sm tracking-[0.2em] uppercase w-16 pt-1">Hours</span>
                                    <span className="text-text text-lg">24/7 — We never close</span>
                                </div>
                                <div className="flex items-start gap-4">
